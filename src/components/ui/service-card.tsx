...
export interface ServiceCardProps
  extends Omit<React.HTMLAttributes<HTMLDivElement>,
    ...
    "whileHover" | "whileTap" | "whileFocus" | "whileInView" | "variants" | "initial" | "animate" | "exit" | "transition" | "layout" | "style"
  >,
    ...
    return (
      ...
      >
        ...
        <motion.img
          ...
          whileHover={{ scale: 1.1, rotate: 3, x: 10, transition: { duration: 0.4, ease: "easeInOut" } }}
        />
      </motion.div>
    );
  }
